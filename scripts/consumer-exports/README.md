...
current exception **and** that the handler is never invoked. Output reports
`dispose=known-failure-346` separately from passing reset/reentrant cases. It is not a
