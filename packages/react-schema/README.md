...
`FormRenderer` creates and owns a declarative runtime around those prepared artifacts. It renders semantic native controls plus built-in tabs and accordion nodes, while unsupported nodes and bindings remain visible diagnostics. Values, policy, lifecycle, and issues remain core-owned.
